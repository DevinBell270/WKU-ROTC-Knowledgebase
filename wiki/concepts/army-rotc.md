...
Junior ROTC (JROTC) in high school is **not required** to join (`raw/corrections/2026-09-24-jrotc-not-required.md`). No source says JROTC earns placement credit; published placement is only for prior service, Guard, or Reserve.
...
WKU also offers academic credentials ([[military-leadership-bs-733]], [[military-science-minor-420]]) that overlap the ROTC sequence but are not identical to “being contracted.” Students can take advanced MIL courses while majoring in Military Leadership without seeking a commission (department courses page).

Outputs if contracted and fully qualified: commission as a Second Lieutenant. See [[commissioning]].
